...
public class TestService {
	...
	public static void main(String[] args) throws ParseException {
		...
		PetSittingRequest req3 = new PetSittingRequest(yourDate1, c2);
		...
		*/
		...
		//object.addClient(c1);
		//object.addClient(c2);
		//object.addPetToClient("victor@yahoo.com", p1);
		//object.addRequestToClient("victor@yahoo.com", req1);
		...
		PetSitterCRUD objj = new PetSitterCRUD() ;
		//objj.addPetSitter(petsitter1);
		//objj.addPetSitter(petsitter2);
		//objj.updatePetSitter("mary_petsittercj@gmail.com", "Maria Ionescu", "passWORD", "Calea Motilor", "0755 467 112", "some experience acolo ceva", 40);
		//objj.getAllPetSitters();
		//objj.addRequestToPetsitter("mary_petsittercj@gmail.com", req3);
		...
		//obbj.addPetSittingRequest(req1);

		//obbj.addPetSittingRequest(req2);
		//obbj.deletePetSittingRequest(6);
